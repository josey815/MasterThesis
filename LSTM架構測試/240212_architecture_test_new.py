...
def testModel(name, opt='Adam', learning_rate=0.005, lstm_layers=1, if_dropout=True, dense_layers=0,
              ...
              batch_size=96, if_early_stopping=False, myPatience=75, epoch=1000):
...
# testModel(name='Adam_0.05', opt = 'Adam', learning_rate=0.05, epoch=1000)
# testModel(name='Adam_0.01', opt = 'Adam', learning_rate=0.01, epoch=1000)
...
# testModel(name='dropout_rate_0.2_neurons_50',dropout_rate=0.2,neurons=50)
# testModel(name='dropout_rate_0.3_neurons_50',dropout_rate=0.3,neurons=50)
# testModel(name='dropout_rate_0.4_neurons_50',dropout_rate=0.4,neurons=50)
# testModel(name='dropout_rate_0.5_neurons_50',dropout_rate=0.5,neurons=50)
# testModel(name='dropout_rate_0.6_neurons_50',dropout_rate=0.6,neurons=50)
# testModel(name='dropout_rate_0.7_neurons_50',dropout_rate=0.7,neurons=50)
# testModel(name='dropout_rate_0.8_neurons_50',dropout_rate=0.8,neurons=50)

# testModel(name='dropout_rate_0.4_neurons_25',dropout_rate=0.4,neurons=25)
# testModel(name='dropout_rate_0.4_neurons_50',dropout_rate=0.4,neurons=50)
# testModel(name='dropout_rate_0.4_neurons_75',dropout_rate=0.4,neurons=75)
# testModel(name='dropout_rate_0.4_neurons_100',dropout_rate=0.4,neurons=100)
...
# testModel(name='batch_size_32', batch_size=32,epoch=1000)
...
testModel(name='RMSprop_final', opt = 'RMSprop', learning_rate=0.005,if_early_stopping=True,myPatience=175, epoch=2000)
